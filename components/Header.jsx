  ...
  return (
    <div className="flex flex-col pb-2 pt-5 md:px-12 lg:px-28 ">
      <div className="flex items-center justify-between">
        ...
        <div className="flex gap-3 text-center justify-center align-center">
      ...
      <div className="text-center my-8">
        ...
        >
          ...
          <button
            type="submit"
            className="border-1 border-l border-black px-4 py-4 sm:px-8 bg-gray-300 active:bg-gray-600 active:text-right active:text-white"
          >
            Subscribe
          </button>
        </form>
