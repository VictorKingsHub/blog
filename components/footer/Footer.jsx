...
const Footer = () => {
  return (
    <footer className="footer flex flex-col justify-center items-center bg-black text-base-100 text-base-content px-10 py-5">
      <div className="flex flex-row justify-between  w-full">
        ...
        >
          <input
            ...
            className=" outline-none self-center w-full h-full px-8 py-2 rounded-tl-sm rounded-bl-sm"
          />
          <button
            type="submit"
